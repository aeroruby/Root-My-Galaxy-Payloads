...
#define BUILD_FINGERPRINT "samsung/r0quew/r0q:16/BP2A.250605.031.A3/S901U1UESAGZF3:user/release-keys"
#endif
...
/* Compatibility aliases expected by slide_app/util.c (older name variants) */
